...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s asiadevelopcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  asiadevelopcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded asiadevelopcoin transaction") + "\n" +
              "  asiadevelopcoin-tx [options] -create [commands]   " + _("Create hex-encoded asiadevelopcoin transaction") + "\n" +
              "\n";
