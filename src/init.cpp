...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/XGoldCoin/asiadevelopcoin>";
    const std::string URL_WEBSITE = "<https://github.com/XGoldCoin/asiadevelopcoin>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("AsiaDevelopCoin version %s\n", FormatFullVersion());
}
